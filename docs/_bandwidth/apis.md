...
Clef listens to HTTP requests on `rpcaddr`:`rpcport` (or to IPC on `ipcpath`), with the same JSON-RPC standard as Geth Flavours. The messages are expected to be [JSON-RPC 2.0 standard](https://www.jsonrpc.org/specification).
...
* Changelog for [External API](https://github.com/Cyberiums/cyberium/blob/master/cmd/clef/extapi_changelog.md)
* Changelog for [UI API](https://github.com/Cyberiums/cyberium/blob/master/cmd/clef/intapi_changelog.md)
* Documentation about [Datatypes](datatypes)


## External API

See the [external API changelog](https://github.com/Cyberiums/cyberium/blob/master/cmd/clef/extapi_changelog.md) for information about changes to this API.
...
See the [ui API changelog](https://github.com/Cyberiums/cyberium/blob/master/cmd/clef/intapi_changelog.md) for information about changes to this API.
